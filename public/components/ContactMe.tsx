  ...
  return (
    <section>
      <div className="position-relative pt-110 w-100">
        <div className="call-action-box round15 d-flex align-items-center justify-content-between gap-3 position-relative w-100">
          <div className="sec-title d-flex flex-column align-items-start">
            <h2 className="mb-0 sz-30">Let's Work Together</h2>
            <p className="mb-0">
          ...
          <div className="btn-box position-relative">
            <a
