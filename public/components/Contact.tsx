  ...
  return (
    <section>
      <div className="position-relative pt-110 w-100">
        <div
          className="contact-wrap round15 position-relative w-100"
          id="contact"
        >
          <div className="row">
            <div className="col-md-12 col-sm-12 col-lg-5">
              <div className="sec-title-wrap mb-40 d-flex flex-column align-items-start position-relative w-100">
                <div
                ...
                >
                  ...
                  <h2 className="mb-0 sz-40">Let's Work Togather On Project</h2>
                </div>
              </div>
              <div
                className="cont-info mb-40 d-inline-flex align-items-center gap-2 wow fadeInUp"
                data-wow-duration=".5s"
                data-wow-delay=".4s"
              >
                <span>
                ...
                <div className="cont-info-inner d-flex align-items-start flex-column">
                  ...
                  <a href="tel:(635) 525-4250" title="Call Us">
                    (635) 525-4250
                  </a>
                </div>
              </div>
            ...
            <div className="col-md-12 col-sm-12 col-lg-7">
              <div className="contact-form position-relative w-100">
                <div className="row mrg20">
                  <div className="col-md-12 col-sm-12 col-lg-12">
                    <div className="field-box position-relative w-100">
                  ...
                  <div className="col-md-12 col-sm-12 col-lg-12">
                    <div className="field-box attachment-field position-relative w-100">
                      <input type="file" />
                      <span>
                        <i className="fal fa-cloud-upload"></i>add an attachment
                      </span>
                    </div>
                    <div className="field-btn position-relative w-100">
                      <button
